...
/**
 * Home Page - Telegram Mini App Profile List
 *
 * Design Philosophy: Modern Minimalist with Telegram Integration
 * - Content-first layout with profile cards as the primary focus
 * - Leverages Telegram's native theme system for consistent styling
 * - Smooth micro-interactions and responsive design
 * - Telegram Main Button for primary actions
 */
export default function Home() {
  ...
  const handleMessage = (profile: any) => {
    ...
    // In a real app, this would navigate to a chat or open Telegram's messaging
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t border-border bg-secondary/30 py-4">
        <div className="container text-center text-xs text-muted-foreground">
          ...
          <p className="mt-1">
            {mockProfiles.length} profiles available
          </p>
        </div>
      </footer>
    </div>
